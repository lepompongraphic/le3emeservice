 ...
 */
final class Version20180619135438 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE don (id INT AUTO_INCREMENT NOT NULL, id_membre INT NOT NULL, description VARCHAR(255) NOT NULL, date_entree DATETIME NOT NULL, reserver VARCHAR(255) NOT NULL, heure_collecte VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
